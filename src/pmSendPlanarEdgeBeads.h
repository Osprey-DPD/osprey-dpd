// pmSendPlanarEdgeBeads.h: interface for the pmSendPlanarEdgeBeads class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDPLANAREDGEBEADS_H__49A15875_3434_46AF_884A_7CD8FAE2D66F__INCLUDED_)
#define AFX_PMSENDPLANAREDGEBEADS_H__49A15875_3434_46AF_884A_7CD8FAE2D66F__INCLUDED_


#include "mpmMessage.h"

class pmSendPlanarEdgeBeads : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendPlanarEdgeBeads();
	
	pmSendPlanarEdgeBeads(const pmSendPlanarEdgeBeads& oldMessage);

	virtual ~pmSendPlanarEdgeBeads();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendPlanarEdgeBeads& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendPlanarEdgeBeads& message);
...
public:
	...
	// so that they may have data read into them given only an pmSendPlanarEdgeBeads pointer,
...
#endif // !defined(AFX_PMSENDPLANAREDGEBEADS_H__49A15875_3434_46AF_884A_7CD8FAE2D66F__INCLUDED_)
