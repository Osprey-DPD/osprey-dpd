// pmSendCubicCornerBeads.h: interface for the pmSendCubicCornerBeads class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDCUBICCORNERBEADS_H__F33A4B2C_F87C_4470_B4BE_B5BA25EE3AB9__INCLUDED_)
#define AFX_PMSENDCUBICCORNERBEADS_H__F33A4B2C_F87C_4470_B4BE_B5BA25EE3AB9__INCLUDED_


#include "mpmMessage.h"

class pmSendCubicCornerBeads : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendCubicCornerBeads();
	
	pmSendCubicCornerBeads(const pmSendCubicCornerBeads& oldMessage);

	virtual ~pmSendCubicCornerBeads();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendCubicCornerBeads& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendCubicCornerBeads& message);
...
private:
    ...
    static const long m_MaxMsgBeads  = 10;          // Max number of beads sent
...
public:
	...
	// so that they may have data read into them given only an pmSendCubicCornerBeads pointer,
...
#endif // !defined(AFX_PMSENDCUBICCORNERBEADS_H__F33A4B2C_F87C_4470_B4BE_B5BA25EE3AB9__INCLUDED_)
