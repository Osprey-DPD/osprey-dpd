// pmSendCubicEdgeBeadForces.h: interface for the pmSendCubicEdgeBeadForces class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDCUBICEDGEBEADFORCES_H__855A9AF1_2D02_43A5_B68C_1E2CF145C23B__INCLUDED_)
#define AFX_PMSENDCUBICEDGEBEADFORCES_H__855A9AF1_2D02_43A5_B68C_1E2CF145C23B__INCLUDED_


#include "mpmMessage.h"

class pmSendCubicEdgeBeadForces : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendCubicEdgeBeadForces();
	
	pmSendCubicEdgeBeadForces(const pmSendCubicEdgeBeadForces& oldMessage);

	virtual ~pmSendCubicEdgeBeadForces();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendCubicEdgeBeadForces& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendCubicEdgeBeadForces& message);
...
public:
	...
	// so that they may have data read into them given only an pmSendCubicEdgeBeadForces pointer,
...
#endif // !defined(AFX_PMSENDCUBICEDGEBEADFORCES_H__855A9AF1_2D02_43A5_B68C_1E2CF145C23B__INCLUDED_)
