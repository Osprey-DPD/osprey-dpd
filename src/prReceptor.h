...
#if !defined(AFX_PRRECEPTOR_H__4e27b5c7_720a_4fbc_81cb_bd7a5c4c15aa__INCLUDED_)
#define AFX_PRRECEPTOR_H__4e27b5c7_720a_4fbc_81cb_bd7a5c4c15aa__INCLUDED_
...
#include "IModifyReceptorProcess.h"

class prReceptor : public IModifyReceptorProcess
{
	// ****************************************
...
public:
	...
	prReceptor(const aeReceptorNetwork* pACN, long start, long end);
...
public:
	...
	void SetACN(const aeReceptorNetwork* pACN);
...
#endif // !defined(AFX_PRRECEPTOR_H__4e27b5c7_720a_4fbc_81cb_bd7a5c4c15aa__INCLUDED_)
