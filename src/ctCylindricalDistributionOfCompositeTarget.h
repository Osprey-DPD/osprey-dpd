// ctCylindricalDistributionOfCompositeTarget.h: interface for the ctCylindricalDistributionOfCompositeTarget class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CTCYLINDRICALDISTRIBUTIONOFCOMPOSITETARGET_H__3f20898e_3067_4c38_8c75_f23a087cbedc__INCLUDED_)
#define AFX_CTCYLINDRICALDISTRIBUTIONOFCOMPOSITETARGET_H__3f20898e_3067_4c38_8c75_f23a087cbedc__INCLUDED_


#include "ctApplyCommand.h"

class ctCylindricalDistributionOfCompositeTarget : public ctApplyCommand
{
	// ****************************************
	// Construction/Destruction: base class has protected constructor
public:

	ctCylindricalDistributionOfCompositeTarget(long executionTime);
	ctCylindricalDistributionOfCompositeTarget(const ctCylindricalDistributionOfCompositeTarget& oldCommand);

	ctCylindricalDistributionOfCompositeTarget(long executionTime, const zString targetLabel,
	...
	virtual ~ctCylindricalDistributionOfCompositeTarget();
...
#endif // !defined(AFX_CTCYLINDRICALDISTRIBUTIONOFCOMPOSITETARGET_H__3f20898e_3067_4c38_8c75_f23a087cbedc__INCLUDED_)
