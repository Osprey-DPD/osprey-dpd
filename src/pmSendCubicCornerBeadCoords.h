// pmSendCubicCornerBeadCoords.h: interface for the pmSendCubicCornerBeadCoords class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDCUBICCORNERBEADCOORDS_H__E799374A_3A9F_46A6_9292_51ADEAA9537B__INCLUDED_)
#define AFX_PMSENDCUBICCORNERBEADCOORDS_H__E799374A_3A9F_46A6_9292_51ADEAA9537B__INCLUDED_


#include "mpmMessage.h"

class pmSendCubicCornerBeadCoords : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendCubicCornerBeadCoords();
	
	pmSendCubicCornerBeadCoords(const pmSendCubicCornerBeadCoords& oldMessage);

	virtual ~pmSendCubicCornerBeadCoords();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendCubicCornerBeadCoords& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendCubicCornerBeadCoords& message);
...
public:
	...
	// so that they may have data read into them given only an pmSendCubicCornerBeadCoords pointer,
...
#endif // !defined(AFX_PMSENDCUBICCORNERBEADCOORDS_H__E799374A_3A9F_46A6_9292_51ADEAA9537B__INCLUDED_)
