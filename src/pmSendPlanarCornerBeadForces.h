// pmSendPlanarCornerBeadForces.h: interface for the pmSendPlanarCornerBeadForces class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDPLANARCORNERBEADFORCES_H__C7BA1253_6B25_42D9_89BE_89F5F70B9C92__INCLUDED_)
#define AFX_PMSENDPLANARCORNERBEADFORCES_H__C7BA1253_6B25_42D9_89BE_89F5F70B9C92__INCLUDED_


#include "mpmMessage.h"

class pmSendPlanarCornerBeadForces : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendPlanarCornerBeadForces();
	
	pmSendPlanarCornerBeadForces(const pmSendPlanarCornerBeadForces& oldMessage);

	virtual ~pmSendPlanarCornerBeadForces();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendPlanarCornerBeadForces& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendPlanarCornerBeadForces& message);
...
private:
    ...
    static const long m_MaxMsgBeads  = 100;   // Max number of beads whose forces are sent
...
public:
	...
	// so that they may have data read into them given only an pmSendPlanarCornerBeadForces pointer,
...
#endif // !defined(AFX_PMSENDPLANARCORNERBEADFORCES_H__C7BA1253_6B25_42D9_89BE_89F5F70B9C92__INCLUDED_)
