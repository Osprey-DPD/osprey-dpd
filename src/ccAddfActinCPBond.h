// ccAddfActinCPBond.h: interface for the ccAddfActinCPBond class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CCADDFACTINCPBOND_H__3574C381_83E3_46CC_9BC3_763BE8F55C06__INCLUDED_)
#define AFX_CCADDFACTINCPBOND_H__3574C381_83E3_46CC_9BC3_763BE8F55C06__INCLUDED_


#include "ccAddActiveCellNetwork.h"

class ccAddfActinCPBond : public ccAddActiveCellNetwork  
{
	// ****************************************
	// Construction/Destruction: base class has protected constructor
public:

	ccAddfActinCPBond(long executionTime);
	ccAddfActinCPBond(const ccAddfActinCPBond& oldCommand);

	virtual ~ccAddfActinCPBond();
...
#endif // !defined(AFX_CCADDFACTINCPBOND_H__3574C381_83E3_46CC_9BC3_763BE8F55C06__INCLUDED_)
