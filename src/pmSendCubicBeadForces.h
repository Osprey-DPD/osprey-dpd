// pmSendCubicBeadForces.h: interface for the pmSendCubicBeadForces class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDCUBICBEADFORCES_H__19A00DB6_3AD6_4BAF_9C72_C2A0E4CE9682__INCLUDED_)
#define AFX_PMSENDCUBICBEADFORCES_H__19A00DB6_3AD6_4BAF_9C72_C2A0E4CE9682__INCLUDED_


#include "mpmMessage.h"

class pmSendCubicBeadForces : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendCubicBeadForces();
	
	pmSendCubicBeadForces(const pmSendCubicBeadForces& oldMessage);

	virtual ~pmSendCubicBeadForces();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendCubicBeadForces& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendCubicBeadForces& message);
...
public:
	...
	// so that they may have data read into them given only an pmSendCubicBeadForces pointer,
...
#endif // !defined(AFX_PMSENDCUBICBEADFORCES_H__19A00DB6_3AD6_4BAF_9C72_C2A0E4CE9682__INCLUDED_)
