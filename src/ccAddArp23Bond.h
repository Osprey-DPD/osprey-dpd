// ccAddArp23Bond.h: interface for the ccAddArp23Bond class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CCADDARP23BOND_H__85BEB5B9_2CB4_41C2_A51D_60B21A3E7FBC__INCLUDED_)
#define AFX_CCADDARP23BOND_H__85BEB5B9_2CB4_41C2_A51D_60B21A3E7FBC__INCLUDED_


#include "ccAddActiveCellNetwork.h"

class ccAddArp23Bond : public ccAddActiveCellNetwork  
{
	// ****************************************
	// Construction/Destruction: base class has protected constructor
public:

	ccAddArp23Bond(long executionTime);
	ccAddArp23Bond(const ccAddArp23Bond& oldCommand);

	virtual ~ccAddArp23Bond();
...
#endif // !defined(AFX_CCADDARP23BOND_H__85BEB5B9_2CB4_41C2_A51D_60B21A3E7FBC__INCLUDED_)
