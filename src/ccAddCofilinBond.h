// ccAddCofilinBond.h: interface for the ccAddCofilinBond class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CCADDCOFILINBOND_H__748522ED_13C7_4879_BE9D_5414E447AA07__INCLUDED_)
#define AFX_CCADDCOFILINBOND_H__748522ED_13C7_4879_BE9D_5414E447AA07__INCLUDED_


#include "ccAddActiveCellNetwork.h"

class ccAddCofilinBond : public ccAddActiveCellNetwork  
{
	// ****************************************
	// Construction/Destruction: base class has protected constructor
public:

	ccAddCofilinBond(long executionTime);
	ccAddCofilinBond(const ccAddCofilinBond& oldCommand);

	virtual ~ccAddCofilinBond();
...
#endif // !defined(AFX_CCADDCOFILINBOND_H__748522ED_13C7_4879_BE9D_5414E447AA07__INCLUDED_)
