// pmSendPlanarCornerBeadCoords.h: interface for the pmSendPlanarCornerBeadCoords class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDPLANARCORNERBEADCOORDS_H__56C02A85_A193_46D6_A845_52AE94F7A47C__INCLUDED_)
#define AFX_PMSENDPLANARCORNERBEADCOORDS_H__56C02A85_A193_46D6_A845_52AE94F7A47C__INCLUDED_


#include "mpmMessage.h"

class pmSendPlanarCornerBeadCoords : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendPlanarCornerBeadCoords();
	
	pmSendPlanarCornerBeadCoords(const pmSendPlanarCornerBeadCoords& oldMessage);

	virtual ~pmSendPlanarCornerBeadCoords();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendPlanarCornerBeadCoords& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendPlanarCornerBeadCoords& message);
...
private:
    ...
    static const long m_MaxMsgBuffer = 10000; // Max number of chars in message buffer
    static const long m_MaxMsgBeads  = 100;   // Max number of beads whose coordinates are sent
...
public:
	...
	// so that they may have data read into them given only an pmSendPlanarCornerBeadCoords pointer,
...
#endif // !defined(AFX_PMSENDPLANARCORNERBEADCOORDS_H__56C02A85_A193_46D6_A845_52AE94F7A47C__INCLUDED_)
