// pmSendPlanarBeadForces.h: interface for the pmSendPlanarBeadForces class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDPLANARBEADFORCES_H__FF802C53_6D0F_43FA_AF08_9167C3AE52D9__INCLUDED_)
#define AFX_PMSENDPLANARBEADFORCES_H__FF802C53_6D0F_43FA_AF08_9167C3AE52D9__INCLUDED_


#include "mpmMessage.h"

class pmSendPlanarBeadForces : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendPlanarBeadForces();
	
	pmSendPlanarBeadForces(const pmSendPlanarBeadForces& oldMessage);

	virtual ~pmSendPlanarBeadForces();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendPlanarBeadForces& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendPlanarBeadForces& message);
...
private:
    ...
    static const long m_MaxMsgBeads  = 20000;   // Max number of beads whose forces are sent
...
public:
	...
	// so that they may have data read into them given only an pmSendPlanarBeadForces pointer,
...
#endif // !defined(AFX_PMSENDPLANARBEADFORCES_H__FF802C53_6D0F_43FA_AF08_9167C3AE52D9__INCLUDED_)
