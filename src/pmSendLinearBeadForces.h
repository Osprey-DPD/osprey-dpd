// pmSendLinearBeadForces.h: interface for the pmSendLinearBeadForces class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDLINEARBEADFORCES_H__A5F5CC17_F3AC_450C_A020_4907659CDDAE__INCLUDED_)
#define AFX_PMSENDLINEARBEADFORCES_H__A5F5CC17_F3AC_450C_A020_4907659CDDAE__INCLUDED_


#include "mpmMessage.h"

class pmSendLinearBeadForces : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendLinearBeadForces();
	
	pmSendLinearBeadForces(const pmSendLinearBeadForces& oldMessage);

	virtual ~pmSendLinearBeadForces();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendLinearBeadForces& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendLinearBeadForces& message);
...
private:
    ...
    static const long m_MaxMsgBeads  = 10000;   // Max number of beads whose forces are sent
...
public:
	...
	// so that they may have data read into them given only an pmSendLinearBeadForces pointer,
...
#endif // !defined(AFX_PMSENDLINEARBEADFORCES_H__A5F5CC17_F3AC_450C_A020_4907659CDDAE__INCLUDED_)
