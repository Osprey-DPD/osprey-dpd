// pmSendCubicCornerBeadForces.h: interface for the pmSendCubicCornerBeadForces class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDCUBICCORNERBEADFORCES_H__DCE3CE29_BF20_47EE_BCD1_9D649F84CD72__INCLUDED_)
#define AFX_PMSENDCUBICCORNERBEADFORCES_H__DCE3CE29_BF20_47EE_BCD1_9D649F84CD72__INCLUDED_


#include "mpmMessage.h"

class pmSendCubicCornerBeadForces : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendCubicCornerBeadForces();
	
	pmSendCubicCornerBeadForces(const pmSendCubicCornerBeadForces& oldMessage);

	virtual ~pmSendCubicCornerBeadForces();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendCubicCornerBeadForces& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendCubicCornerBeadForces& message);
...
public:
	...
	// so that they may have data read into them given only an pmSendCubicCornerBeadForces pointer,
...
#endif // !defined(AFX_PMSENDCUBICCORNERBEADFORCES_H__DCE3CE29_BF20_47EE_BCD1_9D649F84CD72__INCLUDED_)
