// pmSendPlanarBeadCoords.h: interface for the pmSendPlanarBeadCoords class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDPLANARBEADCOORDS_H__94918ABF_0721_4CB8_A0A8_FE346B8DFE04__INCLUDED_)
#define AFX_PMSENDPLANARBEADCOORDS_H__94918ABF_0721_4CB8_A0A8_FE346B8DFE04__INCLUDED_


#include "mpmMessage.h"

class pmSendPlanarBeadCoords : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendPlanarBeadCoords();
	
	pmSendPlanarBeadCoords(const pmSendPlanarBeadCoords& oldMessage);

	virtual ~pmSendPlanarBeadCoords();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendPlanarBeadCoords& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendPlanarBeadCoords& message);
...
public:
	...
	// so that they may have data read into them given only an pmSendPlanarBeadCoords pointer,
...
#endif // !defined(AFX_PMSENDPLANARBEADCOORDS_H__94918ABF_0721_4CB8_A0A8_FE346B8DFE04__INCLUDED_)
