// InitialStateFusionLamella.h: interface for the CInitialStateFusionLamella class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_INITIALSTATEFUSIONLAMELLA_H__2E32FD84_2D5A_11D4_BF36_004095086186__INCLUDED_)
#define AFX_INITIALSTATEFUSIONLAMELLA_H__2E32FD84_2D5A_11D4_BF36_004095086186__INCLUDED_


#include "InitialStateData.h"

class CInitialStateFusionLamella : public CInitialStateData  
{
public:
	CInitialStateFusionLamella();
	virtual ~CInitialStateFusionLamella();

	CInitialStateFusionLamella& operator=(const CInitialStateFusionLamella& oldISL);
...
#endif // !defined(AFX_INITIALSTATEFUSIONLAMELLA_H__2E32FD84_2D5A_11D4_BF36_004095086186__INCLUDED_)
