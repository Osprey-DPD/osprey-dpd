// ctEdgeClampForceOnTarget.h: interface for the ctEdgeClampForceOnTarget class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CTEDGECLAMPFORCEONTARGET_H__a44ec381_691b_4ed5_beff_1834eeedee9a__INCLUDED_)
#define AFX_CTEDGECLAMPFORCEONTARGET_H__a44ec381_691b_4ed5_beff_1834eeedee9a__INCLUDED_


#include "ctApplyCommand.h"

class ctEdgeClampForceOnTarget : public ctApplyCommand  
{
	// ****************************************
	// Construction/Destruction: base class has protected constructor
public:

	ctEdgeClampForceOnTarget(long executionTime);
	ctEdgeClampForceOnTarget(const ctEdgeClampForceOnTarget& oldCommand);

	ctEdgeClampForceOnTarget(long executionTime, const zString targetLabel,
						  const zString decLabel, 
						  long xn, long yn, long zn, 
						  double xc, double yc, double zc, double keff);

	virtual ~ctEdgeClampForceOnTarget();
...
#endif // !defined(AFX_CTEDGECLAMPFORCEONTARGET_H__a44ec381_691b_4ed5_beff_1834eeedee9a__INCLUDED_)
