// pmSendPlanarEdgeBeadCoords.h: interface for the pmSendPlanarEdgeBeadCoords class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDPLANAREDGEBEADCOORDS_H__F63A87F1_6D19_408B_9329_DA11D4ECAD3C__INCLUDED_)
#define AFX_PMSENDPLANAREDGEBEADCOORDS_H__F63A87F1_6D19_408B_9329_DA11D4ECAD3C__INCLUDED_


#include "mpmMessage.h"

class pmSendPlanarEdgeBeadCoords : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendPlanarEdgeBeadCoords();
	
	pmSendPlanarEdgeBeadCoords(const pmSendPlanarEdgeBeadCoords& oldMessage);

	virtual ~pmSendPlanarEdgeBeadCoords();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendPlanarEdgeBeadCoords& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendPlanarEdgeBeadCoords& message);
...
public:
	...
	// so that they may have data read into them given only an pmSendPlanarEdgeBeadCoords pointer,
...
#endif // !defined(AFX_PMSENDPLANAREDGEBEADCOORDS_H__F63A87F1_6D19_408B_9329_DA11D4ECAD3C__INCLUDED_)
