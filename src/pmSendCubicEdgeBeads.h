// pmSendCubicEdgeBeads.h: interface for the pmSendCubicEdgeBeads class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMSENDCUBICEDGEBEADS_H__6CF03D42_E830_4981_B98B_F30703613A76__INCLUDED_)
#define AFX_PMSENDCUBICEDGEBEADS_H__6CF03D42_E830_4981_B98B_F30703613A76__INCLUDED_


#include "mpmMessage.h"

class pmSendCubicEdgeBeads : public mpmMessage  
{
	// ****************************************
	// Construction/Destruction: 
public:

	pmSendCubicEdgeBeads();
	
	pmSendCubicEdgeBeads(const pmSendCubicEdgeBeads& oldMessage);

	virtual ~pmSendCubicEdgeBeads();

	// ****************************************
	// Global functions, static member functions and variables
public:

	friend zOutStream& operator<<(zOutStream& os, const pmSendCubicEdgeBeads& message);
	friend zInStream&  operator>>(zInStream& is,        pmSendCubicEdgeBeads& message);
...
private:
    ...
    static const long m_MaxMsgBeads  = 20;          // Max number of beads sent
...
public:
	...
	// so that they may have data read into them given only an pmSendCubicEdgeBeads pointer,
...
#endif // !defined(AFX_PMSENDCUBICEDGEBEADS_H__6CF03D42_E830_4981_B98B_F30703613A76__INCLUDED_)
